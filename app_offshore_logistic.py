...
with st.sidebar:
    ...
    location_sea_port_lat = st.number_input('OSW  Location lat', -90, 90)
    location_sea_port_lon = st.number_input('OSW  Location lon', -180, 180)
    location_heli_port_lat = st.number_input('OSW  Location lat', -90, 90)
    location_heli_port_lon = st.number_input('OSW  Location lon', -180, 180)
